<x-CRUI :role="'cr'" :title="'CR Panel'" :headerTitle="'Previous year Files'">
    <x-slot name="MainContent">
        <div class="card border-0 shadow-sm">
            ...
            <!-- Filter Form -->
            <form method="GET" action="{{ route('cr.PreviousMaterials') }}" class="p-3 border-bottom">
                                        ...
                                        <tbody>
                                            @foreach ($files as $index => $file)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-{{ strtolower($file->fileType->file_type ?? '') == 'notes' ? 'info' : 'warning' }} text-dark">
